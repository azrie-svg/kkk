...
<header class="header-area header-sticky">
  <div class="container">
    <nav class="main-nav">
      <a href="admin_dashboard.php" class="logo">Lost Items</a>
      <ul class="nav">
      ...
      <div class="col-md-4">
        <div class="card card-custom">
          ...
          <div class="card-body">
            ...
            <form action="mark_as_found.php" method="POST">
              <input type="hidden" name="itemId" value="<?= $row['itemId'] ?>">
              <button type="submit" class="btn btn-found">Mark as Found</button>
            </form>
          </div>
        </div>
      </div>
