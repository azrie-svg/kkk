                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            Hi, <?php echo htmlspecialchars($_SESSION['studentName']); ?>
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
          ...
          <div class="item">
            <div class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <a href="lostitem.php" class="main-stroked-button">Lost items</a>
                  <a href="#" class="main-filled-button">Found items</a>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-text-content">
                        <p><a rel="nofollow noopener" href="https://templatemo.com/tm-543-breezed" target="_parent">Kolej Malinja</a> is one of the residential colleges at UiTM Cawangan Kedah, offering a comfortable and supportive living environment for students. Located within the scenic campus, the college provides essential facilities that cater to students' academic and daily needs. 
                        <br><br>We emphasize holistic student development through various programs, including leadership training, academic support, sports, and community service. Our aim is to nurture well-rounded individuals who are ready to contribute to society.
                      <br><br>With the dedication of our staff and student leaders, Kolej Malinja strives to be more than just a place to stay. it’s a close-knit community where students can grow, connect, and succeed. <a rel="nofollow noopener" href="https://templatemo.com/contact" target="_parent">talk to us</a> if you have anything.</p>
                    </div>
                </div>
            </div>
        </div>
